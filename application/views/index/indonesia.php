        ...
        <div class="page-inner">
            ...
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">Corona Virus Indonesia</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            <div class="card-title my-card-title">Data Kasus Coronavirus di Indonesia Berdasarkan Provinsi</div>
                            <table id="table" data-toggle="table" data-height="460" data-search="true" data-visible-search="true">
                                ...
                                <tbody>
                                    <?php $i = 0;
                                    foreach ($local as $lCorona) : ?>
                                        <?php if ($lCorona['province'] != 'Indonesia') : ?>
                                            <tr>
                                                <td><?= ++$i ?></td>
                                                <td><?= $lCorona['province'] ?></td>
                                                <td><?= number_format($lCorona['confirmed']) ?></td>
                                                <td><?= number_format($lCorona['recovered']) ?></td>
                                                <td><?= number_format($lCorona['deaths']) ?></td>
                                            </tr>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </tbody>
